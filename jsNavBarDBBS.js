...
function buildNavDiv()
{
	...
	var displayContent = "<nav class='navbar navbar-default navbar-fixed-top'><div class='container-fluid'><div class='navbar-header'><button type='button' class='navbar-toggle collapsed' data-toggle='collapse' data-target='#collapsedNav'><span class='sr-only'>Toggle navigation</span><span class='icon-bar'></span><span class='icon-bar'></span><span class='icon-bar'></span><span class='icon-bar'></span></button><a href='http://alpinealicia.com/indexBS.html' class='navbar-brand' id='pageTitle'><strong><span class='glyphicon glyphicon-tree-conifer'></span>   Alpine Alicia</strong></a></div><div class='collapse navbar-collapse'><ul class='nav navbar-nav'><li role='presentation'><a href='http://alpinealicia.com/searchBS.html'><span class='glyphicon glyphicon-search'></span>   Search</a></li><li role='presentation'><a href='http://alpinealicia.com/dateBS.html'><span class='glyphicon glyphicon-calendar'></span>   By Date</a></li><li role='presentation'><a href='http://alpinealicia.com/addTRBS.html'><span class='glyphicon glyphicon-plus'></span>   Add TR</a></li><li role='presentation'><a href='http://alpinealicia.com/modifyTRBS.html'><span class='glyphicon glyphicon-pencil'></span>   Modify TR</a></li></ul><span class='navbar-text navbar-right' id='siteSlogan'><span class='glyphicon glyphicon-edit'></span>     Trip reports from my hikes, climbs, and other adventures</span></div></div></nav>";
